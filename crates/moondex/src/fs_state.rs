...
mod tests {
    ...
    use crate::model::{
        AckDispatchInput, ArchiveStateInput, ClaimTaskInput, ConsumeMailboxForTaskInput,
        ConsumeMailboxInput, CreateTaskInput, ListEventsInput, MarkMailboxReadInput,
        ReadMailboxInput, ReleaseTaskInput, RepairStateInput, RetryDispatchInput,
    ...
    fn dispatch_guards_terminal_role_mismatch_and_records_surface_warning() {
        let store =
            temp_store("dispatch_guards_terminal_role_mismatch_and_records_surface_warning");
        store
            .create_task(CreateTaskInput {
                task_id: "T-01".into(),
                subject: "subject".into(),
    ...
    fn dispatch_inbox_includes_previous_phase_context_and_output_contract() {
        let store =
            temp_store("dispatch_inbox_includes_previous_phase_context_and_output_contract");
        store
            .create_task(CreateTaskInput {
                task_id: "T-01".into(),
                subject: "subject".into(),
